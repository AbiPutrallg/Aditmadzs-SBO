...
#aditmadzs = LineClient(authToken='token kamu')
...
#ki = LineClient()
#ki = LineClient(authToken='EyLXfSb5TB48NeyZhCqa.VtyaRXKBlIv9FuZA9ZSNcG.VnCbc2eVOo47P6vKE+DtsrALUyAob/vJ/IVgpEbSnEo=')
...
owner = ["u8359278cfe3a45f605edc143690f5e88"]
admin = ["u8359278cfe3a45f605edc143690f5e88"]
staff = ["u8359278cfe3a45f605edc143690f5e88"]
...
def siderMembers(to, mid):
    try:
        arrData = ""
        textx = "Total Pengintip「{}」\nWooooyyyy Ngintip² Baee Sini Gabung Chat Biar Rame...!!! ".format(str(len(mid)))
        arr = []
        no = 1
        num = 2
        for i in mid:
...
def welcomeMembers(to, mid):
    try:
        arrData = ""
        textx = "Total Member Masuk「{}」\nHaii Salken Yah Kaka... ;) Moga Betah  ".format(str(len(mid)))
        arr = []
        no = 1
        num = 2
        for i in mid:
...
def leaveMembers(to, mid):
    try:
        arrData = ""
        textx = "Total Member Keluar「{}」\nByee Minggat Sono Jangan Balik Lagi Ke Sini...!!!  ".format(str(len(mid)))
        arr = []
        no = 1
        num = 2
        for i in mid:
            ...
            if cctv['cyduk'][op.param1]==True:
                if op.param1 in cctv['point']:
                    ...
                    if Name in cctv['sidermem'][op.param1]:
                        ...
                        image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                        aditmadzs.sendImageWithURL(op.param1, image)
                        aditmadzs.sendMessage(op.param1, None, contentMetadata={"STKID":"16676118","STKPKGID":"1438760","STKVER":"1"}, contentType=7)
           ...
           if wait["selfbot"] == True:
                 ...
                 if wait["detectMention"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           aditmadzs.sendMessage(msg.to, None, contentMetadata={"STKID":"15535253","STKPKGID":"8205","STKVER":"5"}, contentType=7)
                           break
               if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["Mentiongift"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           aditmadzs.sendMessage(msg.to, "Ngetag Mele Cek PM Sono Ada Sesuatuuu....")
               ...
               if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["Mentionkick"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           aditmadzs.sendMessage(msg.to, "Jangan tag njirrr...")
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "us off":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "「 Abi ♡ Riny SelfBOT 1 Assist 」\n")
...
#===========BOT UPDATE============#
                          ...
                          if msg._from in admin:
                            if msg.to in Setmain['ADITMADZSreadPoint']:
                                ...
                                aditmadzs.sendMessage(msg.to, "Ketik lu on dulu")
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     aditmadzs.sendMessage(msg.to, "Abi ♡ Riny OTW MASUK KE GROUP : %s" % str(group.name))
                                     group1 = ki.findGroupByTicket(ticket_id)
                                     ki.acceptGroupInvitationByTicket(group1.id,ticket_id)
                                     ki.sendMessage(msg.to, "Abi ♡ Riny OTW MASUK KE GROUP : %s" % str(group.name))
